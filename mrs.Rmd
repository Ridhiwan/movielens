...
plot(clst.h,hang = -1) # plot the dendogram
mbr <- cutree(clst.h,20) # choose 5 clusters for my data
```

The cluster dendogram shows that clusters exist in our data and we will choose 20 clusters to visualize our data and reduce the number or increase the number after the analysis of the produced figure.